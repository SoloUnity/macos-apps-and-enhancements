...
- Safari Extensions Bug: If the extension does not appear, enter this command in terminal: Run in terminal if safari extensions bug out: /System/Library/Frameworks/CoreServices.framework/Frameworks/LaunchServices.framework/Support/lsregister -f -R /Applications/Safari.app
